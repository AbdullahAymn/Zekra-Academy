    ...
    <div id="who">
      ...
      <div className=" grid grid-cols-1 lg:grid-cols-2 gap-6 px-8 md:px-16 lg:px-24 ">
        <section className=" col-span-1">
          <Sec
            title={"نبذه عنا"}
            text={`"ذكري" هي أكاديمية متخصصة في تحفيظ القرآن الكريم وتعليمه وفق منهجية علمية حديثة، تهدف إلى تسهيل الحفظ والتلاوة لجميع الفئات العمرية، مع التركيز على الإتقان والالتزام بأحكام التجويد.
`}
          />
...
`}
        ...
        <Sec
          title={"قيمنا"}
          text={`أن تكون "ذكري" الوجهة الأولى لتعليم القرآن الكريم وتحفيظه لجميع الأعمار، مع تقديم بيئة تعليمية محفزة ومرنة تناسب الجميع.
`}
        />
      </div>
    </div>
